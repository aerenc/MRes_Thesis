function [index, indexx, index2 ,index3] = indexes(J,M,T,Total)
...
% m_index   = [J-1:J-1:Total-M*T]';             % indexing each good in every market M*T combination for manipulated case
% 
% m_indexx  = [J-2:J-2:Total-M*T-1*M*T]';     % indexing that will be used in calculating outside good share for manipulated case
% 
